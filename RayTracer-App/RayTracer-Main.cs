...
public class RayTracerMain
{
	...
	public static void drawPoolCompartment( World world, float cbXLim, float poolX, float cbYLim, float poolZ, float botPoolZ )
	{
		...
		Polygon waterPoolTri1 = new Polygon( waterPoolVerts1, Color.poolWater, Phong.cornellPhong, waterRefl, waterTrans, waterIOR );
		Polygon waterPoolTri2 = new Polygon( waterPoolVerts2, Color.poolWater, Phong.cornellPhong, waterRefl, waterTrans, waterIOR );
